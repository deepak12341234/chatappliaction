...
<section>
                       ...
                       while(it.hasNext()){
                          ...
                          name.add((String)peopleDetail.get("name"));
                          //out.println(name);
                       int   number=db.getoffilnemsg((String) peopleDetail.get("email"), (String)users.get("email"));
                          %>
			<div class="row">
				...
				<form action="talk.jsp" class="form-horizontal">
					<div class="col-lg-2">
						<div class="form-group">
							...
							<button type="search" class="btn btn-success">Talk</button>
						</div>
					</div>
				</form>
			</div>
